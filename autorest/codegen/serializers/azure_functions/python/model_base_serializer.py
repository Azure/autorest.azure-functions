...
from autorest.codegen.models import EnumSchema, ObjectSchema, CodeModel, Property, ConstantSchema
...
class ModelBaseSerializer:
    ...
    def prop_documentation_string(prop: Property) -> str:
        ...
        if prop.required:
            description = "Required. " + description if description else "Required. "
        if prop.constant:
