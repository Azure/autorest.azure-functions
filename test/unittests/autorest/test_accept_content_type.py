...
def test_multiple_binary(operation):
    operation.responses = [
        SchemaResponse(
            yaml_data={}, media_types=["image/png", "application/json"], headers=[], binary=True, schema=None,
            status_codes=[204]
        ),
        SchemaResponse(
            yaml_data={}, media_types=["image/png", "application/pdf", "application/xml"], headers=[], binary=True,
            schema=None, status_codes=[200]
        )
    ]
...
def test_multiple_non_binary(operation):
    operation.responses = [
        SchemaResponse(
            yaml_data={}, media_types=["application/xml", "text/json"], headers=[], binary=False, schema={"a": "b"},
            status_codes=[200]
        ),
        SchemaResponse(
            yaml_data={}, media_types=["application/json", "text/json"], headers=[], binary=False, schema=None,
            status_codes=[200]
        )
    ]
...
def test_non_binary_single_response_with_schema(operation):
    operation.responses = [
        SchemaResponse(yaml_data={}, media_types=["image/png", "application/json", "application/xml"], headers=[],
                       binary=False, schema={"a": "b"}, status_codes=[200])
    ]
...
def test_binary_and_non_binary_response_with_schema(operation):
    operation.responses = [
        ...
        SchemaResponse(
            yaml_data={}, media_types=["application/pdf", "application/xml", "text/xml"], headers=[], binary=False,
            schema=None, status_codes=[200]
        )
    ]
